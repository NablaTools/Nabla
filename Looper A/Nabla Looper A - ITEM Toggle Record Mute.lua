...
for i=0, sItems-1 do
  ...
  if action == 'record mute' then
    ...
    reaper.GetSetMediaItemInfo_String(cItem, 'P_EXT:ITEM_ACTION', 'record mute', true)
  end  
  ::next::
end
reaper.UpdateArrange()
reaper.Undo_EndBlock("Toggle Recording Item (MUTE)", -1)
